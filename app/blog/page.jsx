...
export default function Blog() {
  ...
  return (
    <>
      ...
      <Container>
        {/* main div */}
        <div className="grid lg:grid-cols-2 md:grid-cols-1 sm:grid-cols-1 gap-2  w-full ">
          {/* First Card */}
          <div className="relative md:w-full h-[400px] rounded-2xl overflow-hidden border-rose-800 border-4">
            <Image
              src="/blog_1.jpg"
              alt="Contact Image"
              width={800}
            ...
            <div className="absolute bottom-0 left-0 right-0  bg-opacity-30 text-white p-4 rounded-b-2xl">
              ...
              {blogs.map((blog, index) => (
                ...
                >
                  ...
                  <div className="p-6">
                    ...
                    <div className="flex flex-col  absolute bottom-53 left-0 ">
                      <svg
                        width="20"
                        height="20"
                        viewBox="0 0 120 120"
                  ...
                  <div className="flex items-center justify-between p-4">
                    ...
                    <div className="min-w-[1px] h-10 bg-slate-400"></div>
